...
class prime_sieve(object):
    ...
    sieveSize = 30    # Upper limit, highest prime we'll consider
    ...
    def runSieve(this):
        ...
        while (factor < q):
            for num in range (factor, this.sieveSize):
                print('bits', this.rawbits)
                print('numm', num)
                print('half num', int(num/2))
...
sieve = prime_sieve(0)                         #  Calc the primes up to a million
sieve.runSieve() 
sieve.printResults(False, 1, 1)                   # Display outcome